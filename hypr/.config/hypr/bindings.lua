-- Unbind defaults that conflict with Vim navigation, overrides, and custom keys
...
-- Application and Web App overrides
o.bind("SUPER + Q", "Close window", hl.dsp.window.close())
o.bind("SUPER + SHIFT + E", "Gmail", o.launch_webapp_sole("Gmail", "https://mail.google.com/"))
...
-- Relocated defaults and custom shortcuts
...
o.bind("SUPER + SHIFT + SEMICOLON", "Akiflow", o.launch_webapp_sole("Akiflow", "https://web.akiflow.com/"))
o.bind("SUPER + CTRL + SEMICOLON", "Lock system", "omarchy-system-lock")
